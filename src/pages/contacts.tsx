       ...
       <div className="max-w-[490px] bg-b-white border-[1px] border-b-gray pt-[36px] pb-[26px] px-[30px] max-[576px]:px-[10px]">
        ...
        <form action="#">
         ...
         <div className="flex flex-col gap-[11px] mb-[28px]">
          ...
          <select
           className={`w-full text-14 border-[2px] border-b-gray p-[12px] appearance-none bg-[url('./img/svg/arr-down.svg')] bg-no-repeat bg-[length:14px] bg-[right_12px_center] cursor-pointer ${colorSelect}`}
           name="sel"
           id=""
